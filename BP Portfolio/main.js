...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Trigger the animation on initial load if the element is already in the viewport
    handleScrollAnimation();

    window.onscroll = function () {
        // Check visibility for the animation on scroll
        handleScrollAnimation();
    };
    ...
    document.getElementById("reset").addEventListener("click", function () {
        ...
        // Reset the visibility flag when the reset button is clicked
